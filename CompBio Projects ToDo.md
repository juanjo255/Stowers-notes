...
- **This was transferred to Sumhner** (by Aug 18 he is still disappeared)
...
- **This was transferred to Sumhner** (by Aug 18 he is still disappeared)
- For the future, I want to try exploring NCR aligments using PLM. Check this paper: [Leveraging protein language models for accurate multiple sequence alignments](https://doi.org/10.1101/gr.277675.123)
